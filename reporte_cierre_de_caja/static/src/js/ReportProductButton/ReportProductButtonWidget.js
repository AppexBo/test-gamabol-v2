...
import { PopupProductWidget } from "@reporte_cierre_de_caja/js/ReportProductButton/PopupProductWidget";
export class ReportProductButtonWidget extends Component {
    static template = "reporte_cierre_de_caja.ReportProductButtonWidget";
