...
import { PopupPaymentWidget } from "@reporte_cierre_de_caja/js/PaymentReport/PaymentSummaryPopup";

export class ReportPaymentButtonWidget extends Component {
    static template = "reporte_cierre_de_caja.ReportPaymentButtonWidget";
